...
CellRenderer.prototype._render = function(rowIndex, columnIndex, element, value) 
{
	...
	if (this.column.isNumerical()) dataGridOutput.prototype.addClassName(element, "number");

	// always apply the boolean style to boolean column headers
	if (this.column.datatype == 'boolean') dataGridOutput.prototype.addClassName(element, "boolean");
