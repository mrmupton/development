...
dataGridOutput.prototype.setCookie = function(c_name, value, exdays)
{
	var exdate = new Date();
...
dataGridOutput.prototype.getCookie = function(c_name)
{
...
dataGridOutput.prototype.has_local_storage = function() 
{
	try { return 'localStorage' in window && window['localStorage'] !== null; } catch(e) { return false; }
}

dataGridOutput.prototype._localset = function(key, value) 
{
	if (this.has_local_storage()) localStorage.setItem(key, value);
	else this.setCookie(key, value, null);
};

dataGridOutput.prototype._localget = function(key) 
{
	if (this.has_local_storage()) return localStorage.getItem(key);
	return this.getCookie(key);
};

dataGridOutput.prototype._localisset = function(key, value) 
{
	return this._localget(key, value) !== null;
};

dataGridOutput.prototype.localset = function(key, value) 
{
	if (this.enableStore) return this._localset(this.name + '_' + key, value);
};

dataGridOutput.prototype.localget = function(key) 
{
	return this.enableStore ? this._localget(this.name + '_' + key) : null;
};

dataGridOutput.prototype.localisset = function(key, value) 
{
	return this.localget(key, value) !== null;
};

dataGridOutput.prototype.unsort = function(a,b) 
{
...
dataGridOutput.prototype.sort_numeric = function(a,b) 
{
...
dataGridOutput.prototype.sort_boolean = function(a,b) 
{
...
dataGridOutput.prototype.sort_alpha = function(a,b) 
{
	if (a[0].toLowerCase()==b[0].toLowerCase()) return 0;
	return a[0].toLowerCase().localeCompare(b[0].toLowerCase());
};

dataGridOutput.prototype.sort_date = function(a,b) 
{
	date = dataGridOutput.prototype.checkDate(a[0]);
	aa = typeof date == "object" ? date.sortDate : 0;
	date = dataGridOutput.prototype.checkDate(b[0]);
 ...
 * @private
 */
dataGridOutput.prototype.getStyle = function(element, stylePropCamelStyle, stylePropCSSStyle)
{
...
dataGridOutput.prototype.borderRight = function (element) 
{
	return this.borderLeft(element);
};

dataGridOutput.prototype.borderTop = function (element) 
{
...
dataGridOutput.prototype.borderBottom = function (element) 
{
 ...
 * @private
 */
dataGridOutput.prototype.autoWidth = function (element) 
{
 ...
 * @private
 */
dataGridOutput.prototype.autoHeight = function (element) 
{
 ...
 * @private
 */
dataGridOutput.prototype.detectDir = function() 
{
 ...
 * @return boolean
 */
dataGridOutput.prototype.isSame = function(v1, v2) 
{ 
 ...
 * @private
 */
dataGridOutput.prototype.strip = function(str) { return str.replace(/^\s+/, '').replace(/\s+$/, ''); };
dataGridOutput.prototype.hasClassName = function(element, className) { return (element.className.length > 0 && (element.className == className || new RegExp("(^|\\s)" + className + "(\\s|$)").test(element.className))); };
dataGridOutput.prototype.addClassName = function(element, className) { if (!this.hasClassName(element, className)) element.className += (element.className ? ' ' : '') + className; };
dataGridOutput.prototype.removeClassName = function(element, className) { element.className = this.strip(element.className.replace(new RegExp("(^|\\s+)" + className + "(\\s+|$)"), ' ')); };
 ...
 * @private
 */
dataGridOutput.prototype.checkDate = function(strDate, strDatestyle) 
{
