 ...
 */
function dataGridOutput(name, config) { if (name) this.init(name, config); }

/**
 * Default properties
 */ 
dataGridOutput.prototype.enableSort = true;
dataGridOutput.prototype.enableStore = true;
dataGridOutput.prototype.doubleclick = false;
dataGridOutput.prototype.editmode = "absolute"
dataGridOutput.prototype.editorzoneid = "";
dataGridOutput.prototype.allowSimultaneousEdition = false;
dataGridOutput.prototype.saveOnBlur = true;
dataGridOutput.prototype.invalidClassName = "invalid";
dataGridOutput.prototype.ignoreLastRow = false;
dataGridOutput.prototype.caption = null;
dataGridOutput.prototype.dateFormat = "EU";
dataGridOutput.prototype.shortMonthNames = null;
dataGridOutput.prototype.smartColorsBar = ["#dc243c","#4040f6","#00f629","#efe100","#f93fb1","#6f8183","#111111"];
dataGridOutput.prototype.smartColorsPie = ["#FF0000","#00FF00","#0000FF","#FFD700","#FF00FF","#00FFFF","#800080"];
dataGridOutput.prototype.pageSize = 0;

dataGridOutput.prototype.init = function (name, config)
{
	if (typeof name != "string" || (typeof config != "object" && typeof config != "undefined")) {
		alert("The dataGridOutput constructor takes two arguments:\n- name (string)\n- config (object)\n\nGot instead " + (typeof name) + " and " + (typeof config) + ".");
	};
...
dataGridOutput.prototype.tableLoaded = function() {};
dataGridOutput.prototype.chartRendered = function() {};
dataGridOutput.prototype.tableRendered = function(containerid, className, tableid) {};
dataGridOutput.prototype.tableSorted = function(columnIndex, descending) {};
dataGridOutput.prototype.tableFiltered = function() {};
dataGridOutput.prototype.modelChanged = function(rowIndex, columnIndex, oldValue, newValue, row) {};
dataGridOutput.prototype.rowSelected = function(oldRowIndex, newRowIndex) {};
dataGridOutput.prototype.isHeaderEditable = function(rowIndex, columnIndex) { return false; };
dataGridOutput.prototype.isEditable =function(rowIndex, columnIndex) { return true; };
dataGridOutput.prototype.readonlyWarning = function() {};

/**
 * Load metadata and/or data from an XML url
 * The callback "tableLoaded" is called when loading is complete.
 */
dataGridOutput.prototype.loadXML = function(url)
{
 ...
 */
dataGridOutput.prototype.loadXMLFromString = function(xml)
{
	if (window.DOMParser) {
 ...
 * @private
 */
dataGridOutput.prototype.processXML = function()
{
	with (this) {
 ...
 * The callback "tableLoaded" is called when loading is complete.
 */
dataGridOutput.prototype.loadJSON = function(url)
{
	// we use a trick to avoid getting an old version from the browser's cache
	var orig_url = url;
	var sep = url.indexOf('?') >= 0 ? '&' : '?'; 
 ...
 * No callback "tableLoaded" is called since this is a synchronous operation.
 */
dataGridOutput.prototype.loadJSONFromString = function(json)
{
 ...
 * No callback "tableLoaded" is called since this is a synchronous operation.
 */
dataGridOutput.prototype.load = function(object)
{
 ...
 * @private
 */
dataGridOutput.prototype.processJSON = function(jsonData)
{	
 ...
 * @private
 */
dataGridOutput.prototype.processColumns = function()
{
...
dataGridOutput.prototype.parseColumnType = function(column)
{
...
dataGridOutput.prototype.getTypedValue = function(columnIndex, cellValue) 
{
 ...
 */
dataGridOutput.prototype.attachToHTMLTable = function(_table, _columns)
{
	// clear model and pointer to current table
	this.data = [];
	this.dataUnfiltered = null;
 ...
 * @private
 */
dataGridOutput.prototype._createCellRenderer = function(column)
{
	column.cellRenderer = 
 ...
 * @private
 */
dataGridOutput.prototype._createHeaderRenderer = function(column)
{
 ...
 * @private
 */
dataGridOutput.prototype._createCellEditor = function(column)
{
	column.cellEditor = 
 ...
 * @private
 */
dataGridOutput.prototype._createHeaderEditor = function(column)
{
 ...
 */
dataGridOutput.prototype.getRowCount = function()
{
 ...
 */
dataGridOutput.prototype.getColumnCount = function()
{
 ...
 */
dataGridOutput.prototype.hasColumn = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.getColumn = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.getColumnName = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.getColumnLabel = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.getColumnType = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.getColumnUnit = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.getColumnPrecision = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.isColumnBar = function(columnIndexOrName)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.isColumnNumerical = function(columnIndexOrName)
{
	var column = this.getColumn(columnIndexOrName);
 ...
 */
dataGridOutput.prototype.getValueAt = function(rowIndex, columnIndex)
{
 ...
 * @param {Integer} columnIndex
 */
dataGridOutput.prototype.getDisplayValueAt = function(rowIndex, columnIndex)
{
 ...
 */
dataGridOutput.prototype.setValueAt = function(rowIndex, columnIndex, value, render)
{
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.getColumnIndex = function(columnIndexOrName)
{
 ...
 */
dataGridOutput.prototype.getRow = function(rowIndex)
{
 ...
 * @param {Integer} index of the row
 */
dataGridOutput.prototype.getRowId = function(rowIndex)
{
 ...
 */
dataGridOutput.prototype.getRowIndex = function(rowId) 
{
 ...
 */
dataGridOutput.prototype.getRowAttribute = function(rowIndex, attributeName)
{
 ...
 */
dataGridOutput.prototype.setRowAttribute = function(rowIndex, attributeName, attributeValue)
{
 ...
 * @private
 */
dataGridOutput.prototype._getRowDOMId = function(rowId)
{
 ...
 * @param {Integer} rowId
 */
dataGridOutput.prototype.removeRow = function(rowId)
{
 ...
 * @param {Integer} rowIndex
 */
dataGridOutput.prototype.remove = function(rowIndex)
{
 ...
 * @param {Integer} rowIndex
 */
dataGridOutput.prototype.getRowValues = function(rowIndex) 
{
	var rowValues = {};
 ...
 */
dataGridOutput.prototype.append = function(rowId, cellValues, rowAttributes, dontSort)
{
 ...
 * @param {Boolean} dontSort
 */
dataGridOutput.prototype.addRow = function(rowId, cellValues, rowAttributes, dontSort)
{
 ...
 * @private
 */
dataGridOutput.prototype._insert = function(rowIndex, offset, rowId, cellValues, rowAttributes, dontSort)
{
 ...
 * @param {Boolean} dontSort
 */
dataGridOutput.prototype.insert = function(rowIndex, rowId, cellValues, rowAttributes, dontSort)
{
 ...
 * @param {Boolean} dontSort
 */
dataGridOutput.prototype.insertAfter = function(rowIndex, rowId, cellValues, rowAttributes, dontSort)
{
 ...
 */
dataGridOutput.prototype.setHeaderRenderer = function(columnIndexOrName, cellRenderer)
{
 ...
 * @param {CellRenderer} cellRenderer
 */
dataGridOutput.prototype.setCellRenderer = function(columnIndexOrName, cellRenderer)
{
	var columnIndex = this.getColumnIndex(columnIndexOrName);
 ...
 */
dataGridOutput.prototype.setCellEditor = function(columnIndexOrName, cellEditor)
{
	var columnIndex = this.getColumnIndex(columnIndexOrName);
 ...
 * @param {CellEditor} cellEditor
 */
dataGridOutput.prototype.setHeaderEditor = function(columnIndexOrName, cellEditor)
{
	var columnIndex = this.getColumnIndex(columnIndexOrName);
 ...
 */
dataGridOutput.prototype.setEnumProvider = function(columnIndexOrName, enumProvider)
{
	var columnIndex = this.getColumnIndex(columnIndexOrName);
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.clearCellValidators = function(columnIndexOrName)
{
	var columnIndex = this.getColumnIndex(columnIndexOrName);
 ...
 * @param {Object} columnIndexOrName index or name of the column
 */
dataGridOutput.prototype.addDefaultCellValidators = function(columnIndexOrName)
{
	var columnIndex = this.getColumnIndex(columnIndexOrName);
 ...
 * @private
 */
dataGridOutput.prototype._addDefaultCellValidators = function(column)
{
 ...
 */
dataGridOutput.prototype.addCellValidator = function(columnIndexOrName, cellValidator)
{
	var columnIndex = this.getColumnIndex(columnIndexOrName);
 ...
 * @return
 */
dataGridOutput.prototype.setCaption = function(caption)
{
 ...
 */
dataGridOutput.prototype.getCell = function(rowIndex, columnIndex)
{
 ...
 * @private
 */
dataGridOutput.prototype.getCellX = function(oElement)
{
	var iReturnValue = 0;
 ...
 * @private
 */
dataGridOutput.prototype.getCellY = function(oElement)
{
	var iReturnValue = 0;
	while (oElement != null && this.isStatic(oElement)) try {
 ...
 * @return
 */
dataGridOutput.prototype._rendergrid = function(containerid, className, tableid)
{
	with (this) {
 ...
 * @see dataGridOutput#attachToHTMLTable
 * @see dataGridOutput#loadXML
 */
dataGridOutput.prototype.renderGrid = function(containerid, className, tableid)
{
 ...
 * @return
 */
dataGridOutput.prototype.refreshGrid = function()
{
 ...
 * @private
 */
dataGridOutput.prototype._renderHeaders = function() 
{
	with (this) {
		var rows = tHead.rows;
 ...
 * @private
 */
dataGridOutput.prototype.mouseClicked = function(e) 
{
	e = e || window.event;
	with (this) {
 ...
 */
dataGridOutput.prototype.sort = function(columnIndexOrName, descending, backOnFirstPage)
{
	with (this) {
 ...
 */
dataGridOutput.prototype.filter = function(filterString)
{
	with (this) {
 ...
 */
dataGridOutput.prototype.setPageSize = function(pageSize)
{
 ...
 */
dataGridOutput.prototype.getPageCount = function()
{
 ...
 * Returns the number of pages according to the current page size
 */
dataGridOutput.prototype.getCurrentPageIndex = function()
{
 ...
 */
dataGridOutput.prototype.setPageIndex = function(pageIndex)
{
 ...
 * @return
 */
dataGridOutput.prototype.prevPage = function()
{
 ...
 * @return
 */
dataGridOutput.prototype.firstPage = function()
{
 ...
 * @return
 */
dataGridOutput.prototype.nextPage = function()
{
 ...
 * @return
 */
dataGridOutput.prototype.lastPage = function()
{
 ...
 * @return
 */
dataGridOutput.prototype.canGoBack = function()
{
 ...
 * @return
 */
dataGridOutput.prototype.canGoForward = function()
{
 ...
 * @return
 */
dataGridOutput.prototype.getSlidingPageInterval = function(slidingWindowSize)
{
 ...
 * @return
 */
dataGridOutput.prototype.getPagesInInterval = function(interval, callback)
{
	var pages = [];
