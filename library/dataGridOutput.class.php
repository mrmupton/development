...
class dataGridOutput {
	...
	/**
	 * This method formats a number according to the given dataGridOutput type description.
	 * It will give the same result as the Javascript code used by dataGridOutput.
	...
	/**
	 * This method returns the Excel number format for the given dataGridOutput type description.
	 *
	 * @param string $columnType such as double($, 2, dot, comma, 1, n/a)
...
function fetch_pairs($query){
	$dbf = new dataObjectResult($query);
	$results = $dbf->result;
