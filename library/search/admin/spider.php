...
error_reporting(E_ALL);
	...
	require_once ("../../../config/search/admin/$include_dir/commonfuncs.php");
	$all = 0;
	extract (getHttpVars());
	$settings_dir =  "../settings";
	require_once ("../../../config/search/admin/$settings_dir/conf.php");

	include "../../../config/search/admin/messages.php";
