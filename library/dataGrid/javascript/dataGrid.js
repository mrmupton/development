...
var editableGrid = new dataGridOutput("demo", {
...
dataGridOutput.prototype.initializeGrid = function() 
{
	with (this) {
...
//			cell.innerHTML = "<a onclick=\"if (confirm('Are you sure you want to delete this person ? ')) { removeSelectedRow(" + cell.rowIndex + "); editableGrid.renderCharts(); editableGrid.remove(" + cell.rowIndex + "); } \" style=\"cursor:pointer\">" +
...
dataGridOutput.prototype.onloadXML = function(url) 
{
...
dataGridOutput.prototype.onloadJSON = function(url) 
{
	// register the function that will be called when the XML has been fully loaded
	this.tableLoaded = function() { 
...
dataGridOutput.prototype.onloadHTML = function(tableId) 
{
...
function insertNewRow(rowIndex){
	...
	window.alert(rowIndex + newRowId + values);
}
...
dataGridOutput.prototype.renderCharts = function() 
{
...
dataGridOutput.prototype.updatePaginator = function()
{
...
dataGridOutput.prototype.duplicateRow = function(rowIndex) 
{
...
dataGridOutput.prototype.addRow = function(rowIndex){
