<?php 
	include_once('../library/includeFiles.class.php'); new includeFiles('dataGrid'); 
	$qstr = 'q='.urlencode('SELECT *, date_format(lastvisit, "%d/%m/%Y") as lastvisit FROM demo');
?>	
<script>
window.onload = function() { 
				// you can use "datasource/demo.php" if you have PHP installed, to get live data from the demo.csv file
				editableGrid.onloadJSON(<?php echo '"library/demo.php?'.htmlentities($qstr).'"'; ?>);
			};
<?php     
