...
if (isset($Submit)) {
	if (!is_writable("../../../config/search/settings/conf.php")) {
		print "Configuration file is not writable, chmod 666 conf.php under *nix systems";
	} else {
		$fhandle=fopen("../../../config/search/settings/conf.php","wb");
		fwrite($fhandle,"<?php \n");
...
include "../../../config/search/settings/conf.php";
?>
<div id='submenu'>&nbsp;</div>
<div id="settings">

<form name="form1" method="post" action="../../../config/search/admin/admin.php">
