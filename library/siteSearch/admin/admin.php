...
$include_dir = "../include";
include "../../../config/search/admin/auth.php";
include "../../../config/search/admin/$include_dir/commonfuncs.php";
include "../../../config/search/admin/spiderfuncs.php";
extract (getHttpVars());
$settings_dir = "../settings";
$template_dir = "../templates";
include "../../../config/search/admin/$settings_dir/conf.php";
set_time_limit (0);
...
<link rel="stylesheet" href="../../../config/search/admin/admin.css" type="text/css" />
</head>
<body>
<?php
if (!isset($f)) {
...
<div id="admin">
	<div id="tabs">
		...
		<li><a href="../../../config/search/admin/admin.php?f=2" id="<?php print $site_funcs[$f]?>">Sites</a>  </li>
		<li><a href="../../../config/search/admin/admin.php?f=categories" id="<?php print $cat_funcs[$f]?>">Categories</a></li>
		<li><a href="../../../config/search/admin/admin.php?f=index" id="<?php print $index_funcs[$f]?>">Index</a></li>
		<li><a href="../../../config/search/admin/admin.php?f=clean" id="<?php print $clean_funcs[$f]?>">Clean tables</a> </li>
		<li><a href="../../../config/search/admin/admin.php?f=settings" id="<?php print $settings_funcs[$f]?>">Settings</a></li>
		<li><a href="../../../config/search/admin/admin.php?f=statistics" id="<?php print $stat_funcs[$f]?>">Statistics</a> </li>
		<?php if ($db->getAttribute(constant("PDO::ATTR_DRIVER_NAME")) == 'mysql') {?>
		<li><a href="../../../config/search/admin/admin.php?f=database" id="<?php print $database_funcs[$f]?>">Database</a></li>
		<?php }?>
		<li><a href="../../../config/search/admin/admin.php?f=24" id="default">Log out</a></li>
		</ul>
	</div>
	<div id="main">
...
<?php
	function list_cats($parent, $lev, $color, $message) {
		...
		if ($lev == 0) {
			...
			<div id="submenu">
				<ul>
				<li><a href="../../../config/search/admin/admin.php?f=add_cat">Add category</a> </li>
				</ul>
			</div>
			<?php
			print $message;
...
?>
	   <br/><center><table><tr><td valign=top align=center colspan=2><b>Parent: <?php print "<a href=admin.php?f=add_cat&parent=$par2num>$par2</a> >".stripslashes($par)?></b></td></tr>
		<form action=../../../config/search/admin/admin.php method=post>
...
<?php
	...
	function showsites($message) {
		...
		<div id='submenu'>
		 <ul>
		  <li><a href='../../../config/search/admin/admin.php?f=add_site'>Add site</a> </li>
		  <?php
			if ($row) {
				?>
				<li><a href='../../../config/search/admin/spider.php?all=1'> Reindex all</a></li>
				<?php
			}
			?>
		 </ul>
	...
	function indexscreen ($url, $reindex) {
		...
		<form action="../../../config/search/admin/spider.php" method="post">
	...
	function siteScreen($site_id, $message)  {
		...
		<div id= "vertmenu">
		<ul>
		 <li><a href=../../../config/search/admin/admin.php?f=edit_site&amp;site_id=<?php print  $row['site_id']?>>Edit</a></li>
		<li><?php print $indexoption?></li>
		<li><a href=../../../config/search/admin/admin.php?f=21&amp;site_id=<?php print  $row['site_id']?>>Browse pages</a></li>
		<li><a href=../../../config/search/admin/admin.php?f=5&amp;site_id=<?php print  $row['site_id'];?> onclick="return confirm('Are you sure you want to delete? Index will be lost.')">Delete</a></li>
		<li><a href=../../../config/search/admin/admin.php?f=19&amp;site_id=<?php print  $row['site_id'];?>>Stats</a></li>
		</div>
		</ul>
		</div>
		</center>
	...
	function browsePages($site_id, $start, $filter, $per_page) {
		...
		<br/>
		<center>
		<b>Pages of site <a href="../../../config/search/admin/admin.php?f=20&amp;site_id=<?php  print $site_id?>"><?php print $url;?></a></b><br/>
		<p>
		<form action="../../../config/search/admin/admin.php" method="post">
	...
	function cleanForm () {
		...
		<br/><div align="center">
		<table cellspacing ="0" cellpadding="0" class="darkgrey"><tr><td align="left"><table cellpadding="3" cellspacing = "1"  width="100%"><tr class="grey"  ><td align="left"><a href="../../../config/search/admin/admin.php?f=15" id="small_button">Clean keywords</a>
		 </td><td align="left"> Delete all keywords not associated with any link.</td></tr>
		<tr class="grey"  ><td align="left"><a href="../../../config/search/admin/admin.php?f=16" id="small_button">Clean links</a>
		</td><td align="left"> Delete all links not associated with any site.</td></tr>
		<tr class="grey"  ><td align="left"><a href="../../../config/search/admin/admin.php?f=17" id="small_button">Clear temp tables </a>
		</td><td align="left"> <?php print $temp;?> items in temporary table.</td></tr>
		<tr class="grey"  ><td align="left"><a href="../../../config/search/admin/admin.php?f=23" id="small_button">Clear search log </a>
	...
	function statisticsForm ($type) {
		...
		<div id='submenu'>
		<ul>
		<li><a href="../../../config/search/admin/admin.php?f=statistics&amp;type=keywords">Top keywords</a></li>
		<li><a href="../../../config/search/admin/admin.php?f=statistics&amp;type=pages">Largest pages</a></li>
		<li><a href="../../../config/search/admin/admin.php?f=statistics&amp;type=top_searches">Most popular searches</a></li>
		<li><a href="../../../config/search/admin/admin.php?f=statistics&amp;type=log">Search log</a></li>
		<li><a href="../../../config/search/admin/admin.php?f=statistics&amp;type=spidering_log">Spidering logs</a></li>
		</ul>
		</div>
	...
	switch ($f) {
		...
		break;
		case database;
			include "../../../config/search/admin/db_main.php";
		break;
		case settings;
			include('../../../config/search/admin/configset.php');
		break;
		case 'delete_log';
			unlink($log_dir."/".$file);
