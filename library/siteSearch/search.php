...
include ("../../config/search/$include_dir/commonfuncs.php");
//extract(getHttpVars());

require_once("../../config/search/$settings_dir/database.php");
require_once("../../config/search/$include_dir/searchfuncs.php");
require_once("../../config/search/$include_dir/categoryfuncs.php");

include "../../config/search/$settings_dir/conf.php";
...
require_once("../../config/search/$language_dir/$language-language.php");
require_once "../../config/search/$template_dir/$template/header_$language.html";
...
require_once("../../config/search/$template_dir/$template/search_form.html");
...
function poweredby () {
    ...
    print $sph_messages['Powered by'];?>  <a href="http://www.sphider.eu/"><img src="../../config/search/sphider-logo.png" border="0" style="vertical-align: middle" alt="Sphider"></a>
...
switch ($search) {
	case 1:
		...
		require("../../config/search/$template_dir/$template/search_results.html");
	break;
	default:
		if ($show_categories) {
			...
			require("../../config/search/$template_dir/$template/categories.html");
		}
	break;
	}

include "../../config/search/$template_dir/$template/footer.html";
?>
